              ...
              {filteredItems.map((i, index) => (
                <>
                  <div id={"card-0" + index} key={"card-0" + index} className="card">
                    <a href={'https://one.etrolls.in/#/'+i.videoId}> <img className="card-img-top"  src={'https://img.youtube.com/vi/'+i.videoId+'/hqdefault.jpg'} alt='Coffee Recipe Javascript Project'/> <svg id='imgsvg' xmlns='http://www.w3.org/2000/svg' width='64' height='64' viewBox='0 0 24 24' fill='none' stroke='#ffffff' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' class='feather feather-play-circle'><circle cx='12' cy='12' r='10'></circle><polygon points='10 8 16 12 10 16 10 8'></polygon></svg> </a>
